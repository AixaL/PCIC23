...
def paso_ent(modelo,fp_edades,fp_genero,fp_reg,metrica_edades,metrica_genero, metrica_edadN, opt, X, y_edad, y_genero, y_reg):
  ...
  y_hat_edad, y_hat_genero, y_hat_reg = modelo(X) 
...
def entrena(modelo,fp_edades,fp_genero, fp_reg, metrica_edades, metrica_genero, metrica_edadN, opt, entdl, valdl, disp, ckptpath, n_epocas=10, tbdir='runs/'):
...
#   tbwriter = SummaryWriter(tbdir)
  ...
  for e in range(n_epocas):
    ...
    for Xlote, ylote_edades, ylote_genero, ylote_reg, *_ in entdl:
      ...
      perdida_paso, metrica_edad_paso, metrica_genero_paso, metrica_reg_paso, weightedf1 = paso_ent(modelo, fp_edades, fp_genero, 
                                                                                                    fp_reg, metrica_edades, 
                                                                                                    metrica_genero, metrica_edadN, 
                                                                                                    opt, Xlote, ylote_edades, 
                                                                                                    ylote_genero, ylote_reg)
...
red= Xvector((30*63), num_classes=NUM_CLASES_AGE, task=3)
# red= LSTMDvector(63, num_classes=NUM_CLASES_AGE, task=3)
# red = QuartzNet(30, task=3)
...
wandb.init(
    ...
    "architecture": "XVector Multitask",
    "dataset": DATASET,
    "epochs": N_EPOCAS,
    "edadWeight":1.0,
    "genWeight":1.0,
...
red_Xvect2, mejor_Xvect2, hist_Xvect2 = entrena(red, perdida_edades, perdida_genero, perdida_edadN,
                                   ...
                                   dl_val,
                                   DC,
                                   LOGDIR + '/red_Xvector_Multitask_'+DATASET+'_'+TASA_AP2+'_.pt',
                                   n_epocas=N_EPOCAS,
                                   tbdir = LOGDIR)