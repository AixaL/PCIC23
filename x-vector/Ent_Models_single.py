...
# Redes
from Models import QuartzNet, LSTMDvector, Xvector, QuartzNet_single
...
wandb.init(
    ...
    "architecture": "QuartzNet_single Age 3 Class Dropout",
    "dataset": DATASET,
    "epochs": N_EPOCAS,
    "edadWeight":1.0,
    "genWeight":1.0,
...
red_Xvect2, mejor_Xvect2, hist_Xvect2 = entrena(red, perdida_edades, perdida_genero, perdida_edadN,
                                   ...
                                   dl_val,
                                   DC,
                                   LOGDIR + '/red_QuartzNet_single_Age_3_Class_Drop_'+DATASET+'_'+TASA_AP2+'_30MFCC.pt',
                                   n_epocas=N_EPOCAS,
                                   tbdir = LOGDIR, task=1)