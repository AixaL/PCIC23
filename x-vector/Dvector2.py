...
summary(test_layer, (40, 23,81), device='cpu',col_names=['input_size', 'output_size', 'num_params'])
...
# %%
Red_xvect = LSTMDvector(81, onlyGender=True)
...
red= LSTMDvector(81, onlyGender=True)
red.to(DC)
