...
# %%
test_layer = LSTMDvector(81, onlyGender=True)
summary(test_layer, (40, 30,81), device='cpu',col_names=['input_size', 'output_size', 'num_params'])
...
# %%
Red_xvect = LSTMDvector(161, onlyGender=True)
...
red= LSTMDvector(161, onlyGender=True)
red.to(DC)
...
plt.savefig('./images/comparacion_accuracy_genero_DVector_'+TASA_AP+'_'+DATASET+'_.png')
...
# Guarda el gráfico en un archivo (puedes cambiar el formato según tus necesidades)
plt.savefig('./images/comparacion_perdida_DVector_'+TASA_AP+'_'+DATASET+'_.png')
...
if DATASET !='TIMIT':
    ...
    # Guarda el gráfico en un archivo (puedes cambiar el formato según tus necesidades)
    plt.savefig('./images/DVector/comparacion_Accuracy_Edades_DVector_'+TASA_AP+'_'+DATASET+'_.png')
    ...
    # Guarda el gráfico en un archivo (puedes cambiar el formato según tus necesidades)
    plt.savefig('./images/DVector/comparacion_MSE_Edad_DVector_'+TASA_AP+'_'+DATASET+'_.png')
    ...
    # Guarda el gráfico en un archivo (puedes cambiar el formato según tus necesidades)
    plt.savefig('./images/DVector/comparacion_weightedF1_DVector_'+TASA_AP+'_'+DATASET+'_.png')
